...
func TestAccComputeNetworkEdgeSecurityServices_withRegionSecurityPolicies(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeSecurityPolicy_withDdosProtectionConfig_regionApi(polNameStandard),
			},
			{
...
func testAccComputeSecurityPolicy_withDdosProtectionConfig_regionApi(spName string) string {
	return fmt.Sprintf(`
